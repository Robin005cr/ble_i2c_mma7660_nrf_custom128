...
#define CUSTOM_VALUE_CHAR_UUID_A            0x1401
#define CUSTOM_VALUE_CHAR_UUID_B          0x1402
...
struct ble_cus_s
{
    ...
    ble_gatts_char_handles_t      custom_value_handles_A;          /**< Handles related to the Custom Value characteristic. */
    ble_gatts_char_handles_t      custom_value_handles_B; 
