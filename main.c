...
#define DEVICE_NAME                     "ACCSENSOR"                       /**< Name of device. Will be included in the advertising data. */
...
static void notification_timeout_handler(void * p_context)
{
    ...
    MMA7660_ReadCord(AccValue); 
    //printf("%d-%d-%d",AccValue[0],AccValue[1],AccValue[2]);
    err_code = ble_cus_custom_value_update(&m_cus, AccValue);
    APP_ERROR_CHECK(err_code);
}
...
static void services_init(void)
{
       ...
       // cus_init.initial_custom_value = 0x10;
